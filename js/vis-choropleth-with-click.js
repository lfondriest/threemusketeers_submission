...
var color = d3.scaleThreshold()
    .range(["#fee0d2","#fcbba1","#fc9272","#fb6a4a","#ef3b2c","#cb181d","#a50f15","#67000d", "#3B0007" ]);
...
function updateChoropleth(selected2) {
    ...
    var colorList = ["#fee0d2","#fcbba1","#fc9272","#fb6a4a","#ef3b2c","#cb181d","#a50f15","#67000d", "#3B0007"];;
    //var labelList = [0, 1, 10, 50, 100, 250, 500, 1000, 2500, 5000];
    var labelList = [1, 5, 10, 25, 50, 100, 500, 1000];
...
function spaceFiller2() {
    ...
    d3.select(".col-sm-3")
        ...
        .html(function(d){
            return("<ul>" +
                "<li><div class=\"numberCircleTrade\">1</div> Select which category you are interested in</li>" +
                "<br><li><div class=\"numberCircleTrade\">2</div> Hover over a country to see its total exports/imports</li>" +
                "<br><li><div class=\"numberCircleTrade\">3</div> Click countries to see their largest trade partners</li>" +
                "<br><li><div class=\"numberCircleTrade\">4</div> Click the bars on the barchart that appears to change your selected country</li>" +
                "</ul>")
        });
}